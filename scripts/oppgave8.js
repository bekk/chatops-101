...
const trondheimYrURL = 'http://www.yr.no/sted/Norge/Trøndelag/Trondheim/Trondheim/varsel.xml';

module.exports = function (robot) {
  robot.respond(/hva bør jeg ha på meg når jeg går ut/, function (res) {
    request(trondheimYrURL, function (error, response) {
      ...
      } else if (regnMengde >= 0.5 && regnMengde < 3) {
